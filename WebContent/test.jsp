...
<h2 id ="icoMypage"><a href="mypage.html"><img src="images/mypage.png" alt="Mypage"></a></h2>
<form action="userInsert">
	<input class="userInsert" type="submit" value="会員登録">
</form>
<!--PC用（801px以上端末）メニュー-->
<nav id="menubar">
<ul>
...
<input type="submit" name=><img src="images/sample_photo1.jpg" alt="タイトル">
<h4>タイトル</h4>
</form>
</div>
...
<div class="list2">
<a href="item.html">
<figure><img src="images/sample_photo1.jpg" alt="タイトル"></figure>
<h4>タイトル</h4>
</a>
</div>
...
<h3>利用規約のご案内</h3>
<p>このテンプレートは、<a href="https://template-party.com/">Template Party</a>にて無料配布している『ブリーダー向け 無料ホームページテンプレート tp_breeder4』です。必ずダウンロード先のサイトの<a href="https://template-party.com/read.html">利用規約</a>をご一読の上でご利用下さい。</p>
...
<h3>動物の写真はダウンロードファイルには梱包されていません</h3>
<p>配布元である「素材辞典」さんの一般利用規約範囲内で利用している為、ダウンロードファイルには梱包されておりません。PSD特典にも含まれませんので必要な際は「素材辞典」さんで直接お買い求め下さい。</p>
...
<dl>
<dt>2019/01/24</dt>
<dd>html,cssなど全面リニューアル。旧ファイルが必要な場合はお問い合わせ下さい。<span class="newicon">NEW</span></dd>
<dt>2016/08/17</dt>
<dd>tp_breeder4公開。</dd>
<dt>20XX/00/00</dt>
...
<h2>Puppy情報</h2>
<ul class="submenu">
<li><a href="list.html">トイプードル</a></li>
<li><a href="list.html">チワワ</a></li>
<li><a href="list.html">ダックス</a></li>
<li><a href="#">メニュー</a></li>
<li><a href="#">メニュー</a></li>
</ul>
</nav>
...
<footer>
<small>Copyright&copy; <a href="index.html">SAMPLE BREEDER</a> All Rights Reserved.</small>
